        ...
        <div class="about-card">
          ...
          <section class="about-section">
            ...
            <div class="section-body">
              <p>
                你好，我是
                <strong>SilentFall</strong>，一名喜欢打游戏的普通人。
              </p>
              <p>
                目前处于初三和高中阶段，主要兴趣和精力都投在了探索Vibe Coding开发和打瓦上。
              </p>
            </div>
          </section>
          ...
          <section class="about-section">
            ...
            <div class="contact-list">
              <div class="contact-item">
                ...
                <span class="contact-value">3552931982</span>
              </div>
              <div v-if="info.email" class="contact-item">
                <span class="contact-label">邮箱</span>
                <span class="contact-value">LJB110814@163.com</span>
              </div>
              <div class="contact-item">
