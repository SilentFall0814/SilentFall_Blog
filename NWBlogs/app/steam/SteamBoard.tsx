  ...
  return (
    <div className="w-full max-w-7xl mx-auto px-4 sm:px-10 py-10 relative z-10">
      ...
      <div className="mb-8 flex flex-col sm:flex-row items-center gap-4 w-full">
        ...
        <div className="flex items-center gap-1 bg-white/30 dark:bg-slate-800/30 backdrop-blur-md rounded-full px-1.5 py-1 border border-white/20 dark:border-white/5">
          {tabs.map((tab) => (
            <button
              key={tab.key}
