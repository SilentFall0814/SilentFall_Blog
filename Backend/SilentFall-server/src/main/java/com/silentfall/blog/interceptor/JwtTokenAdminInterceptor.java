package com.silentfall.blog.interceptor;

import com.silentfall.blog.constant.JwtClaimsConstant;
...
import com.silentfall.blog.exception.GuestReadOnlyException;
import com.silentfall.blog.exception.NotLoginException;
import com.silentfall.blog.exception.UnauthorizedException;
import com.silentfall.blog.properties.JwtProperties;
import com.silentfall.blog.service.TokenService;
import com.silentfall.blog.utils.JwtUtil;
...
public class JwtTokenAdminInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        try {
            ...
            String adminId = claims.get(JwtClaimsConstant.ADMIN_ID).toString();
