...
export default function FriendsBoard() {
  ...
  // 预设的申请格式
  const applyFormat = `名称：SilentFallの博客\n简介：今天我也要学习吗\n链接：https://你的地址`;
            ...
            >
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center gap-2 md:gap-5 relative z-10 mb-2 md:mb-4">
                ...
                <div className="flex-1 overflow-hidden w-full">
                  {/* 🌟 核心修改 5：标题字体缩小 */}
                  <h2 className="text-sm md:text-xl font-bold text-slate-900 dark:text-white group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors truncate md:whitespace-nowrap whitespace-normal break-all">
                    {friend.name}
                  </h2>
