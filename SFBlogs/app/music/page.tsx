      ...
      <PageTransition>
        <div className="w-full max-w-7xl mx-auto mt-24 md:mt-28 px-4 sm:px-6 md:px-10 relative z-10">
          ...
          <div className="flex flex-col md:grid md:grid-cols-12 gap-6 md:gap-8 w-full md:items-stretch md:h-[calc(100vh-320px)] md:min-h-[600px] md:max-h-[720px]">
            ...
            {/* ====== 左侧/顶部：播放控制台 ====== */}
            {/* 🌟 核心修改 1：加入了 min-h-[460px] sm:min-h-[500px] 强制在手机端拉高矩阵盒子！而在电脑端 md:min-h-0 恢复默认 */}
            ...
            {/* ====== 右侧/底部：歌词与歌单面板 ====== */}
            <div className="md:col-span-7 flex flex-col bg-white/40 dark:bg-slate-800/50 backdrop-blur-md border border-white/40 dark:border-white/10 rounded-[32px] shadow-2xl relative transition-colors duration-700 overflow-hidden h-[350px] sm:h-[450px] md:h-auto shrink-0">
