...
export default function VisitorMomentEditor({ onClose, onSuccess }: { onClose: () => void; onSuccess: () => void }) {
  ...
  const ToolbarButton = ({ onClick, active, children, title }: any) => (
    <button
      ...
      onClick={onClick}
      title={title}
      className={`p-2 md:p-1.5 rounded-lg transition-all text-slate-500 dark:text-slate-400 toolbar-btn ${
        ...
        >
          <div className="p-6 md:p-8">
            ...
            <div className="bg-white/60 dark:bg-slate-800/60 border border-slate-200/50 dark:border-slate-700/50 rounded-2xl overflow-hidden">
              <div className="flex items-center gap-0.5 px-3 py-2 border-b border-slate-200/50 dark:border-slate-700/50 flex-wrap editor-toolbar">
            ...
            <div className="flex items-center justify-between mt-6 editor-actions">
