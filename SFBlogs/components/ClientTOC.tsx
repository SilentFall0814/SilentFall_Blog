...
export default function ClientTOC({ toc }: { toc: TocItem[] }) {
  ...
  return (
    <div className="bg-white/60 dark:bg-slate-800/50 backdrop-blur-xl rounded-3xl p-6 border border-white/40 dark:border-white/10 shadow-xl lg:sticky lg:top-28 transition-colors duration-700 lg:max-h-[75vh] overflow-y-auto custom-scrollbar toc-sidebar">
