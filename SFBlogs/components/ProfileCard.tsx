...
export default function ProfileCard({ articleCount, momentCount, photoCount }: { articleCount: number, momentCount: number, photoCount: number }) {
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between relative z-10">
        <div className="flex items-center gap-4 md:gap-6 w-full profile-card-inner">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-end justify-between mt-6 md:mt-8 gap-5 md:gap-6 relative z-10">
        <div className="flex gap-2 sm:gap-6 w-full md:w-auto justify-between sm:justify-around md:justify-start px-2 sm:px-0">
          <StatItem count={articleCount} label="文章" color="text-indigo-600 dark:text-indigo-400" />
