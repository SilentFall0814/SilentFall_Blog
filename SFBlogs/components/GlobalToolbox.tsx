      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="mb-2 bg-white/70 dark:bg-slate-800/80 backdrop-blur-2xl border border-white/50 dark:border-white/10 shadow-2xl rounded-3xl p-4 w-64 flex flex-col gap-4 overflow-hidden toolbox-panel"
          >
            {/* 动态渲染：工具箱导航栏 */}
